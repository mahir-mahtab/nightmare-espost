...
async function setupTestEvent() {
  ...
  // Create players
  const playersData = [
    { name: 'Player One', role: 'Duelist', rankPoint: 85, basePrice: 500 },
    { name: 'Player Two', role: 'Controller', rankPoint: 90, basePrice: 800 },
    { name: 'Player Three', role: 'Sentinel', rankPoint: 75, basePrice: 300 },
  ];
