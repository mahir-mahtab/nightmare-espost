...
async function setupTestEvent() {
  ...
  // Create players
  const playersData = [
    { name: 'Player One', role: 'IGL', rank: '85', basePrice: 500 },
    { name: 'Player Two', role: 'Support', rank: '90', basePrice: 800 },
    { name: 'Player Three', role: 'Assaulter', rank: '75', basePrice: 300 },
  ];
